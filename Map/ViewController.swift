...
class ViewController: UIViewController {
    ...
    func setUpGoButton() {
        ...
        NSLayoutConstraint.activate([
            ...
            goButton.centerYAnchor.constraint(equalTo: view.centerYAnchor, constant: 275),
    ...
    func checkLocationAuthorisation() {
        ...
        case .denied:
            let ac = UIAlertController(title: "Location has been denied", message: "Please turn on Location Services. Go to Settings, Privacy, Location Services and turn on Location Services for Map.", preferredStyle: .alert)
            ac.addAction(UIAlertAction(title: "OK", style: .default))
        case .notDetermined:
